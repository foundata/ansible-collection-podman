...
- [Ansible role: `foundata.podman.quadlet`](roles/quadlet/README.md#ansible-role-foundatapodmanquadlet)
  ...
  - [Role variables](roles/quadlet/README.md#variables)
    ...
    - [`quadlet_podman_units`](roles/quadlet/README.md#variable-quadlet_podman_units)
      ...
      - [`quadlet_podman_units['service_state']`](roles/quadlet/README.md#variable-quadlet_podman_units-sub-service_state)
    - [`quadlet_podman_systemd_units`](roles/quadlet/README.md#variable-quadlet_podman_systemd_units)
      - [`quadlet_podman_systemd_units['name']`](roles/quadlet/README.md#variable-quadlet_podman_systemd_units-sub-name)
      - [`quadlet_podman_systemd_units['sections']`](roles/quadlet/README.md#variable-quadlet_podman_systemd_units-sub-sections)
      - [`quadlet_podman_systemd_units['service_state']`](roles/quadlet/README.md#variable-quadlet_podman_systemd_units-sub-service_state)
